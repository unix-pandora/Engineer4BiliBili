# import os
import sys
sys.path.append('./src/api/reading')
sys.path.append('./src/api/video_info')
sys.path.append('./src/api/entity')
sys.path.append('./src/api/command')
sys.path.append('./src/api/writing')
sys.path.append('./src/api/consts')
